...
log using results/imputation_ahi_2.txt, replace
...
postfile myfile_2 str20 MGS double rho p_value N using "results/cor_ahi_imput_mgs_2.dta", replace

use work/pheno_2.dta, clear
