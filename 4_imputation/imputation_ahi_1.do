...
log using results/imputation_ahi_1.txt, replace
...
postfile myfile_1 str20 MGS double rho p_value N using "results/cor_ahi_imput_mgs_1.dta", replace

use work/pheno_1.dta, clear
